 ...
 */
void RGBConverter::rgbToHsl(double r, double g, double b, double hsl[]) {
 ...
 */
void RGBConverter::hslToRgb(double h_, double s, double l, double rgb[]) {
    double r, g, b;
    double h = h_/360;
 ...
 */
void RGBConverter::rgbToHsv(double r, double g, double b, double hsv[]) {
    double rd = (double) r/255;
    double gd = (double) g/255;
    double bd = (double) b/255;
...
double RGBConverter::max(double a, double b) {
    if (a > b) return a;
    else return b;
}

double RGBConverter::min(double a, double b) {
    if (a < b) return a;
    else return b;
}
